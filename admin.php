...
/*$result = mysqli_query($con, "SELECT admin.username, teacher.username FROM admin JOIN teacher WHERE (admin.username = '$username' and admin.password = '$password') OR (teacher.username = '$username' and teacher.password = '$password')") or die('Error');*/
